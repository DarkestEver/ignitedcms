...
<div class="row" style="margin-left:30px; margin-right:30px;">
  <div class="col-sm-12">
            <section class="panel">
              <header class="panel-heading font-bold"><h3><?php echo('Add Product') ?></h3></header>
                          ...
                          <div class="panel-body"> 
                            ...
                            <div class="form-group"> 
                              <label class="col-sm-2 control-label">Name:</label> 
                               <div class="col-sm-10"> 
                                <input type="text" name="name" id="name" class="form-control"  data-required="true" placeholder=""> 
                               </div> 
                            </div>
                            ...
                            <!-- rich text editor -->
                             <div class="form-group"> 
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-10"> 
                                  <input name="h" type="text" data-required="true" data-maxlength="10" class="form-control" placeholder="Type here" data-toggle="tooltip" data-placement="top" title="Height in mm" value="">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                               ...
                               <div class="col-sm-10"> 
                                  <input name="w" type="text" data-required="true" data-maxlength="10" class="form-control" placeholder="Type here" data-toggle="tooltip" data-placement="top" title="Width in mm" value="">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                               ...
                               <div class="col-sm-10"> 
                                  <input name="d" type="text" data-required="true" data-maxlength="10" class="form-control" placeholder="Type here" data-toggle="tooltip" data-placement="top" title="Depth in mm" value="">
                                </div>
                              </div>
